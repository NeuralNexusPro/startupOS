...
| ONT.5 | OSDK Facts / Actions API | In Progress（ONT5-T1） | Critical | 类型化 facts 查询、Action submit、版本/修订检查、幂等恢复与审计 metadata |
...
ONT.1、ONT.2、ONT.3、ONT.4 已完成；ONT.7 已完成最小协议，其他 Story 仍处于规划阶段。
