...
**Epic:** ONT  
**状态:** 🟡 In Progress（ONT7-T1 Done；ONT7-T2 Proposal Ready）
...
- [ ] ONT7-T2 提供按 execution identity 的 projection query 与 latest 语义。
- [ ] ONT7-T2 精确解析 fact references，失败时返回结构化错误且不返回部分结果。
