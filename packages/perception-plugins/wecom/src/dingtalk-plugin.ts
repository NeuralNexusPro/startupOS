import { DingTalkStreamNormalizer, parseFrameData } from '@originos/core/lib/integrations/perception';
import type { DingTalkStreamFrame } from '@originos/core/lib/integrations/perception';
...
export const dingtalkManifest: PerceptionPluginManifest = {
  id: 'originos.dingtalk', name: '钉钉', version: '0.1.0', hostApi: '1.0', entry: '@originos/perception-plugin-wecom/dingtalk', source: 'dingtalk', transport: 'stream',
...
export class DingTalkPerceptionPlugin implements PerceptionPlugin {
  ...
  async handleWebhook(context: PerceptionPluginRuntimeContext, request: PerceptionPluginWebhookRequest): Promise<PerceptionPluginWebhookResult> {
    ...
    const frameData = typeof rawData === 'string'
      ? rawData
      : rawData !== null && !Array.isArray(rawData) && typeof rawData === 'object' ? parseFrameData(rawData) : {};
